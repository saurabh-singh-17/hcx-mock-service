...
public class HCXFHIRUtils {
    ...
    public static Bundle resourceToBundle(DomainResource res, List<DomainResource> referencedResource, Bundle.BundleType type, String bundleURL, HCXIntegrator integrator) throws Exception {
        ...
        FhirValidator validator = HCXFHIRValidator.getValidator(integrator.getConfig());
