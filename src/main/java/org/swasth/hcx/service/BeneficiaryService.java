...
public class BeneficiaryService {
    ...
    public ArrayList<Map<String,Object>> checkCommunicationRequest(Map<String, Object> requestBody) throws ClientException, SQLException {
        ...
        statusList.add(getResponse("policy_consent", resultSet.getString("otp_verification")));
        statusList.add(getResponse("capture_bank_details", resultSet.getString("bank_details")));
        return statusList;
    }

    public Map<String, Object> getResponse(String type, String status) {
        Map<String, Object> response = new HashMap<>();
