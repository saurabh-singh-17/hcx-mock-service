...
public class ParticipantResponse {
    ...
    private org.swasth.hcx.dto.ResponseError error;
    ...
    public ParticipantResponse(org.swasth.hcx.dto.ResponseError error) {
        this.timestamp = System.currentTimeMillis();
        this.error = error;
    }
    ...
    public org.swasth.hcx.dto.ResponseError getError() {
        return error;
    }
